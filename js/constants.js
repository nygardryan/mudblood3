...
const ENEMY_TYPES = {
  ...
  // Movement speed is the exception: it keeps its old, slower value so waves
  // still take the same time to close. Stormtrooper has no direct Allied pair,
  // so it takes a flat +10% over its old numbers. See docs/axis-units.md.
  erifle: {
    name: 'Rifleman', hp: 110, speed: 22, range: 169, dmg: 14, acc: 0.6,
    rof: 0.79, burst: 1, burstGap: 0, reward: 2,
    color: '#5e5e52', gun: 7, sfx: 'rifle', priority: 1,
  },
  esmg: {
    name: 'Stormtrooper', hp: 77, speed: 36, range: 96, dmg: 8, acc: 0.46,
    rof: 0.9, burst: 3, burstGap: 0.07, reward: 2,
    color: '#46443a', gun: 6, sfx: 'mg', priority: 1,
  },
  egren: {
    name: 'Grenadier', hp: 110, speed: 27, range: 101, dmg: 11, acc: 0.6,
    rof: 1.08, burst: 1, burstGap: 0, reward: 3,
    color: '#524e3e', gun: 5, sfx: 'pistol', priority: 2, grenade: true,
  },
  emg: {
    name: 'MG Gunner', hp: 110, speed: 16, range: 197, dmg: 10, acc: 0.35,
    rof: 1.22, burst: 7, burstGap: 0.08, reward: 3,
    color: '#484640', gun: 10, sfx: 'mg', priority: 3,
  },
  eoff: {
    name: 'Officer', hp: 105, speed: 24, range: 111, dmg: 10, acc: 0.55,
    rof: 0.81, burst: 1, burstGap: 0, reward: 4,
    color: '#4a4840', gun: 5, sfx: 'pistol', priority: 5, aura: true,
  },
  esniper: {
    name: 'Sniper', hp: 94, speed: 14, range: 274, dmg: 51, acc: 0.79,
    rof: 4.68, burst: 1, burstGap: 0, reward: 4,
    color: '#464438', gun: 12, sfx: 'sniper', priority: 4,
  },
  eflame: {
    name: 'Flamethrower', hp: 143, speed: 34, range: 78, dmg: 0, acc: 0,
    rof: 1, burst: 1, burstGap: 0, reward: 4,
    color: '#4a4438', gun: 8, sfx: 'rifle', priority: 3,
    flame: { range: 78, arc: 0.45, dps: 42 },
    blastResist: 0.5,
  },
  emortar: {
    name: 'Granatwerfer', hp: 99, speed: 18, range: 97, dmg: 9, acc: 0.52,
  ...
  estug: {
    name: 'StuG III', hp: 880, speed: 12, range: 221, dmg: 0, acc: 0,
  ...
  etiger: {
    name: 'Tiger I', hp: 1980, speed: 5, range: 265, dmg: 0, acc: 0,
  ...
  // comes up.
  ev2: {
    name: 'V2 Rocket Battery', hp: 590, speed: 18, range: 0, dmg: 0, acc: 0,
