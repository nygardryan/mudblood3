...
const UNIT_TYPES = {
  ...
  grenadier: {
    ...
    desc: 'Carbine and frag grenades. Can throw back enemy grenades.',
  },
  shotgunner: {
    ...
    desc: 'M97 trench gun. High HP but close range.',
  },
  bazooka: {
    ...
    desc: 'M1A1 rocket launcher. Inaccurate, bonus damage to armor.',
  },
  mortarman: {
  ...
  flamer: {
    ...
    desc: 'M2 flamethrower. Burns everything in the cone. Limited fuel.',
  },
  jeep: {
    ...
    desc: 'Willys jeep, .50 cal. Fast and unarmored. Fires on the move.',
  },
  sherman: {
    ...
    desc: 'M4 Sherman. 75mm cannon and thick armor.',
  },
  atgun: {
    ...
    desc: '57mm anti-tank gun. Immobile. Fires only at vehicles.',
  },
  aagun: {
    ...
    desc: '40mm Bofors. Immobile. Fires only at aircraft and paratroopers.',
  },
};
...
const ENEMY_INFO = {
  erifle: 'Kar98k rifleman. Slow and steady.',
  esmg: 'MP40. Fast, close range.',
  egren: 'Stick grenades. Indiscriminate blast.',
  emg: 'MG42 gunner. Long-range sustained fire.',
  eoff: 'Officer. Nearby troops resist suppression.',
  esniper: 'Scoped rifle. Hunts support and officers.',
  eflame: 'Flamethrower. Burns in a cone.',
  emortar: '81mm mortar. Long range. Cannot fire close.',
  ebazooka: 'Panzerfaust. Bonus damage to armor. Inaccurate.',
  ebike: 'Motorcycle. Very fast.',
  ejeep: 'Kübelwagen, mounted MG. Light armor.',
  ehalftrack: 'Sd.Kfz. 251. Armored. Squad dismounts.',
  panzer: 'Panzer IV. 75mm cannon and thick armor.',
  estug: 'StuG III. Casemate 75mm.',
  etiger: 'Tiger I. 88mm gun and very heavy armor.',
  ev2: 'V2 rocket. Long range, inaccurate.',
  eboss: 'Der Schlächter. Heavy armor. Falls back to reload.',
  ...
  jrifle: 'Arisaka rifleman. Never goes prone.',
  jbanzai: 'Bayonet charger. Melee only.',
  jsmg: 'Type 100 SMG. Fast, close range.',
  jgren: 'Type 97 grenades. Indiscriminate blast.',
  jlmg: 'Type 99 LMG. Long-range sustained fire.',
  jhmg: 'Type 92 heavy MG. Slow, long range.',
  jmortar: '81mm mortar. Long range. Cannot fire close.',
  jsniper: 'Scoped rifle. Hidden until he fires.',
  jknee: 'Knee mortar. Short range, fast firing.',
  jlunge: 'Lunge mine. Detonates on armor.',
  joff: 'Officer. Can order a banzai charge.',
  jflame: 'Flamethrower. Burns in a cone.',
  jhago: 'Ha-Go. Fast light tank, 37mm gun.',
  jtank: 'Chi-Ha. 57mm gun. Light armor.',
  jchinu: 'Chi-Nu. Heavy armor, 75mm gun.',
  jyamato: 'Land battleship. Armor belt and batteries.',
  jyhull: 'Armor belt. Hits damage the ship.',
  jyturret: 'Main battery. Own hit points.',
  jymg: 'Gun tub. No armor.',
  ...
  zshambler: 'Slow corpse. Bite can infect.',
  zrunner: 'Fast corpse. Low HP.',
  zcrawler: 'Small crawling corpse. Bite can infect.',
  zhound: 'War dog. Very fast. Pounces.',
  zbrute: 'Heavy corpse. High HP.',
  zspitter: 'Lobs bile. Area damage and infection.',
  zbloater: 'Bursts into infectious rot.',
  zscreamer: 'A scream sends nearby dead into a sprint.',
  zrevenant: 'Kar98 rifle. Poor aim.',
  zjumper: 'Vaults the trench. Blasts on landing.',
  zcharger: 'Bone-plated bull. Rams in a straight line.',
  zabom: 'Boss corpse. Enormous HP.',
  zprogen: 'Crawling mass. Births zombies and raises the dead.',
  zpod: 'Pus sac. Lobs bile.',
  ...
  iguast: 'Sapper. Digs works, then fights.',
  ifante: 'Carcano rifleman. Fights from cover.',
  iuff: 'Officer. Speeds the AVANTI charge.',
  imed: 'Medic. Heals one man at a time.',
  imosch: 'MAB 38 SMG. Fast, close range.',
  ibreda: 'Breda 30 LMG. Fights from cover.',
  ifiat: 'Heavy MG. Pins from a bunker.',
  icecc: 'Scoped rifle. Longer range from towers.',
  ibrixia: '45mm mortar. Short range, fast firing.',
  imortaio: '81mm mortar. Long range. Cannot fire close.',
  ifolgore: 'Paratrooper. Grenades. Never digs in.',
  iardito: 'Demolition man. Charges your emplacements.',
  iflame: 'Flamethrower. Burns in a cone.',
  il3: 'Flame tankette. Thin armor, close range.',
  im13: 'M13/40. Slow, 47mm gun.',
  isemo: 'Semovente. Casemate 75mm.',
  ibersa: 'Trench gun. Fast, close range.',
  awalker: 'Tripod walker. Laser sweep beyond rifle range.',
  itrain: 'Armored train. Parks and shells the trench.',
};
