...
let hoverActor = null; // actor or emplacement under the cursor, described in a panel while hovered
let touchInspect = null; // actor or emplacement pinned by a mobile long-press/tap, so its info panel shows on touch
